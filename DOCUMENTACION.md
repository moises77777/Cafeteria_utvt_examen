...
El presente proyecto consiste en el desarrollo de un sistema web de gestión para la cafetería de la Universidad Tecnológica del Valle de Toluca (UTV). Este sistema permite administrar dos entidades principales: los tipos de comida (categorías) y las comidas ofrecidas.
...
Desarrollar un sistema web CRUD (Create, Read, Update, Delete) completo para la gestión de tipos de comida y comidas de la cafetería UTV, implementando relaciones de base de datos y validaciones de formularios.
